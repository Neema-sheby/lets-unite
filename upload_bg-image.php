<?php
 ...
 if(strpos($url, 'upload_bg-image.php')== true){

  echo "
  <div class='upload background'>
   <h2 class='heading-2 text-align'>UPLOAD BACKGROUND IMAGE</h2>
   <form method='post'>
      ...
      <div class='modal-dialog modal-dialog-centered modal-lg'>
        ...
        <div class = modal__container>
          <div class='modal-header'>
            ...
            <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close' id='close_bg'></button>
          </div>
